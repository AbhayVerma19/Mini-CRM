      ...
      <div className="flex justify-center   w-full  items-center ">
        <div className="w-full  bg-white p-16 rounded-lg custom-shadow grid grid-cols-2 gap-10" style={{height:600}}>
          <div>
            ...
            <p className="mb-5 pl-10 text-xl">Empower your business with our seamless CRM system, designed to streamline customer interactions and boost productivity. Transform every customer touchpoint into a growth opportunity!</p>
